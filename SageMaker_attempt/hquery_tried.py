    ...
    try:
        response = sagemaker.create_processing_job(
            ...
            AppSpecification={
                ...
                "ContainerEntrypoint": ["python3", "/opt/ml/processing/summarization.py"]
            },
            RoleArn=ROLE_ARN,
            ProcessingInputs=[
                ...
                },
                {
                    "InputName": "news-info",
                    "S3Input": {
                        "S3Uri": f"s3://{INPUT_BUCKET}/{file_name}",
                        "LocalPath": "/opt/ml/processing/news",
                        "S3DataType": "S3Prefix",
                        "S3InputMode": "File"
                    }
                },
                ...
                },
                {
                    "InputName": "tokenizer",
                    "S3Input": {
                        "S3Uri": f"s3://{INPUT_BUCKET}/ML_model/tokenizer/",
                        "LocalPath": "/opt/ml/processing",
                        "S3DataType": "S3Prefix",
                        "S3InputMode": "File"
                    }
